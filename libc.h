...
//Use the preprocessor to change libc functions to syscalls through <arch>-syscalls.s
	...
	#define nanosleep(x,y)				syscall2(SYS_nanosleep, x, y)
	...
	#define shutdown(x,y)				syscall3(SYS_shutdown, x, y)
	...
	#define rt_sigaction(w,x,y,z)		syscall4(SYS_rt_sigaction,w,x,y,z)
